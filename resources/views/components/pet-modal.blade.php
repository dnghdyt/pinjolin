    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="/animal" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>
                        <select id="spesies" name="spesies"
                            ...
                            required>
                            <option selected disabled>Spesies hewan</option>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="foto_hewan" name="foto_hewan" accept=".jpg, .jpeg, .png" type="file" required>
                        @error('foto_hewan')
                            <div class="text-red-600">
                                {{ $message }}
                            </div>
